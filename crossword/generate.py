...
class CrosswordCreator():
    ...
    def enforce_node_consistency(self):
        ...
        for v in self.domains:
            domain = deepcopy(self.domains[v])
        ...
        for var_1, val_1 in assignment.items():
            ...
            for var_2, val_2 in assignment.items():
                if var_1 != var_2:
                    ...
                    overlaps = self.crossword.overlaps[var_1, var_2]
                    if overlaps:
                        v1, v2 = overlaps
                        if val_1[v1] != val_2[v2]:
                            return False
    ...
    def order_domain_values(self, var, assignment):
        ...
        dt ={value :0 for value in self.domains[var] if value not in assignment}
        ...
        # create a sorted list from low to high according to values of n
    ...
    def select_unassigned_variable(self, assignment):
        ...
        for var in self.domains:
            if var not in assignment:
                result.append([var, len(self.domains[var]),
